...
// (context-1m-2025-08-07). Applied to BOTH heartbeat ticks and Marc's
...
// Model + betas the team-lead CHANNEL should also use for Marc's interactive
// messages — the heartbeat and his messages share one session, so they must
...
// it — instead we warn Marc as its context climbs (once per WARN_EVERY tokens)
// so he can /reset on his own terms. Set a non-zero TEAMLEAD_MAX_CONTEXT_TOKENS
...
// Act on Marc's queued Trello changes right away (only when TRELLO_NUDGE_ON_CHANGE
