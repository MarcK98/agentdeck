...
export async function startDiscord() {
  ...
  client.on("messageCreate", async (message) => {
    try {
      ...
      // The team-lead channel shares one session between the owner's messages and the
  ...
  try {
    ...
    // Trello board sync posts the owner's board changes into the team-lead channel and
