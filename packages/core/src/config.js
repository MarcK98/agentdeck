...
export const config = {
  ...
  trello: {
    // Mirror the team lead's TASKS.md to a Trello board and surface the owner's board
    ...
    // How often to poll the board for the owner's changes (moves/adds/comments).
